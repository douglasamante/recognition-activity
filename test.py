"""
This code was updated due to hardware computational complexity.
"""
...
def merge_csi_label(csifile, labelfile, win_len=1200, thrshd=0.9, step=200):
...
def extract_csi_by_label(ra'w_folder,' label, labels, save=False, win_len=1000, thrshd=0.9, step= '00):
    """
    ...
    Args:
        ...
        labels   : list of str, ['Horizontal Arm Wave' 'High Arm Wave' 'Two Hands Wave' 'High Throw' 'Draw X' 'Draw Tick' 'Toss Paper']
    ...
    if not label in labels:
        raise ValueError("The label {} should be among Horizontal Arm Wave' 'High Arm Wave' 'Two Hands Wave' 'High Throw' 'Draw X' 'Draw Tick' 'Toss Paper'".format(labels))
...
def extract_csi(raw_folder, labels, save=False, win_len=1200, thrshd=0.9, step=200):
    """
...
if __name__ == "__main__":
    ...
    # preprocessing
    cfg = CSIModelConfig(win_len=1200, step=200, thrshd=0.9, downsample=2)
